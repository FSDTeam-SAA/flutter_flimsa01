abstract class AuthServiceInterface {
  ...
  Future<dynamic> register(String fullName, String email, String password, String comfirmPassword);
  ...
  Future<dynamic> resetPassword(String email, String password, String newPassword);
