import 'package:flimsa01mvp/features/explore/genres.dart';
import 'package:flimsa01mvp/features/explore/sort_filter.dart';
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SortFilterPage(),
                          ),
                        );
                      },
                    ),
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset(
                            genre['image']!,
                            width: 164,
                            height: 100, // Slightly reduced for better layout
                            fit: BoxFit.cover,
                          ),
                        ),
