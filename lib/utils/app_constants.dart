...
class AppConstants {
  ...
  static const String baseUrl = 'https://flimsa14.scaleupdevagency.com';
  ...
  static const String forgetPassword = '/api/password/email';

  static const String otpVerification = '/api/password/verify-otp';

  static const String resendOtp = '/api/password/email';
